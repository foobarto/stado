...
- A failed bundled wasm rebuild used to wipe `internal/bundledplugins/wasm/`; `internal/bundledplugins/build.sh` now builds into a temp dir first and only swaps outputs on success.
