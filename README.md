...
| --- | --- |
| **Tools are plugins + signed WASM runtime** ([EP-0002](docs/eps/0002-all-tools-as-plugins.md), [EP-0006](docs/eps/0006-signed-wasm-plugin-runtime.md), [EP-0038](docs/eps/0038-abi-v2-bundled-wasm-and-runtime.md)) | Keep the tool surface replaceable instead of baking integrations into the loop; bundled and third-party WASM tools share a capability-gated ABI, trust policy, and `wazero` runtime. |
