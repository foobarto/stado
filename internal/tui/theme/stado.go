...
// Apply updates the package-level theme globals used by older TUI
// subpackages. Newer code should prefer explicit *Theme handles, but
// this keeps pickers and the editor in sync when a theme is switched at
// runtime.
func Apply(th *Theme) {
	if th == nil {
		return
