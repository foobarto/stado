...
func stadoFSToolWrite(argsPtr, argsLen, resultPtr, resultCap uint32) int32
...
func stadoToolWrite(argsPtr, argsLen, resultPtr, resultCap int32) int32 {
	return stadoFSToolWrite(uint32(argsPtr), uint32(argsLen), uint32(resultPtr), uint32(resultCap))
}
