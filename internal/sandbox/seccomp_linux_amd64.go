...
// syscallTable maps human syscall names to amd64 numbers. Populated
// via unix.SYS_* constants so the kernel's canonical mapping is
// authoritative — no risk of hand-typed drift.
