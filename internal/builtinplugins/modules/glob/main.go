...
func stadoFSToolGlob(argsPtr, argsLen, resultPtr, resultCap uint32) int32
...
func stadoToolGlob(argsPtr, argsLen, resultPtr, resultCap int32) int32 {
	return stadoFSToolGlob(uint32(argsPtr), uint32(argsLen), uint32(resultPtr), uint32(resultCap))
}
