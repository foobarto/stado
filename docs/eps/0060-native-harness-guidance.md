...
history:
  - date: 2026-08-14
    status: Partial
    note: >
      EP-0066 preserves native deterministic guidance facts but moves wording,
      thresholds, recommendation choices, and composition policy into a WASM
      lifecycle application. Status is Partial until that migration lands.
  - date: 2026-08-12
    status: Accepted
