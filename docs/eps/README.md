...
| 0061 | [Linked EP Relationship Metadata](./0061-linked-ep-relationship-metadata.md) | Process | Superseded |
| 0062 | [Rendered EP Relationship Links](./0062-rendered-ep-relationship-links.md) | Process | Implemented |
...
Optional, added as relevant (see EP-1 and EP-62 for full semantics):
...
§"Updating EPs" and EP-62 for the full rule.
